        ...
        def self.rank_octocats(project_name)
          ...
          Octokit.forks(project_name).each do |fk|
            ...
            repositories.each do |repo|
              if repo.language && repo.language.downcase == 'ruby' ? ruby_projects = ruby_projects + 1 : repo.language && repo.language.downcase == 'javascript' ? js_projects = js_projects + 1 : nil
